                ...
                <div className="rounded-2xl overflow-hidden border border-amber-200 bg-amber-50">
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 p-4">
                    <div className="flex items-center gap-3">
                      {/* Spotify logo */}
                      <div className="w-10 h-10 rounded-full bg-[#1DB954] flex items-center justify-center shrink-0 shadow">
                      ...
                      <div>
                        <p className="text-xs font-bold text-amber-700 uppercase tracking-wide">Ambiance sonore</p>
                        <p className="text-sm font-semibold text-amber-950 leading-tight">
                          Écoutez l&apos;ambiance parfaite pour jouer à <span className="text-amber-700">{jeu.nom}</span>
                        </p>
                      </div>
                    </div>
                    <a
                      ...
                      className="shrink-0 inline-flex items-center gap-1.5 bg-[#1DB954] hover:bg-[#1aa34a] text-white text-xs font-bold px-4 py-2 rounded-full transition-colors shadow-sm"
                    >
